...
public class AnalizadorLexicoTiny {
  ...
  private GestionErroresTiny0 error;
  ...
  public AnalizadorLexicoTiny(Reader input, GestionErroresTiny0 error) throws IOException {
    this.input = input;
  ...
  private void error(){
    error.errorLexico(filaActual,columnaActual,(char)sigCar);
  }
  ...
  public static void main(String arg[]) throws IOException {
    ...
    AnalizadorLexicoTiny al = new AnalizadorLexicoTiny(input,error);
    UnidadLexica unidad;
    do {
      unidad = al.sigToken();
